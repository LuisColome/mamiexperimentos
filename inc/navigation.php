...
function ea_site_header() {
    ...
    echo '<div class="nav-header"><a title="' . get_bloginfo('name') . '" href="' . get_bloginfo('url') . '" style="background: url(' . get_bloginfo('url') . '/wp-content/themes/box-theme/assets/images/cfhh-logo-white-gold.png);background-size:cover;">' . get_bloginfo('name') . '</a></div>';
