...
function ea_site_header() {
    ...
    echo '<div class="nav-header"><a title="' . get_bloginfo('name') . '" href="' . get_bloginfo('url') . '" style="background: url(' . get_stylesheet_directory_uri() . '/assets/images/logo-white.png);background-size:cover;">' . get_bloginfo('name') . '</a></div>';
